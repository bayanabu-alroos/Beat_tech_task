              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase  font-weight-bolderps-2">Name</th>
                    <th class="text-center text-uppercase  font-weight-bolder ">Description</th>
                    <th class="text-center text-uppercase  font-weight-bolder ">Name buyer</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ ++$i }}</td>
                    <td>
                        <img src="/images/{{ $product->image }}" class="me-3 border-radius-lg"  width="100px" alt="user1">
